...
from training.mast3r.train_transformer import Config
...
Module = TransformerUNet3DLightningModule


def eval_run(run_name, project_name):

    path = f".lightning/{project_name}/{project_name}/{run_name}/checkpoints/epoch=23-step=12288-val_loss=0.44.ckpt"
