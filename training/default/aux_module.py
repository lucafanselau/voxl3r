...
from networks.surfacenet import SmallSurfaceNetConfig, SurfaceNet
...
class LightningModuleWithAux(BaseLightningModule):
    def __init__(
        ...
        super().__init__(module_config, ModelClass, occGridSampler)
        ...
        aux_model = BaseLightningModule.load_from_checkpoint(path, module_config=config, ModelClass=models[module_config.model_class], occGridSampler=occGridSampler).model
