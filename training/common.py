...
def create_dataset_rgb(config, split: str, transform=nn.Module):
    ...
    image_dataset = chunk.image_loader_compressed.Dataset(config, base_dataset, split=config.split)
...
class DataConfigRGB(DataConfig, chunk.image_loader.Config, transforms.SmearImagesConfig, transforms.PairingTransformConfig):
    pass
