...
def main():
    ...
    search_space = {
        ...
        "refinement_blocks": ["block1x1_3x3", "simple", "block3x3_1x1"],
        #"skip_dropout_p": [0.75, 1]
    }

    experiment_name = "05_used_blocks_refinement_2"
    config.name = "mast3r-3d-experiments"

    tune(train.train, config, search_space, num_samples=3, experiment_name=experiment_name)
